  ...
  return (
    <View style={styles.container}>
        ...
        {showDateLeavePicker && (
          <DateTimePicker
            ...
            onChange={(event, selectedDate) =>
              handleDateChange(event, selectedDate, 'leave')
            }
          />
        )}
        <Text style={styles.selectedDate}>
          Selected Date Leave: {dateLeave.toDateString()}
        </Text>
      </View>
      {errors.date_leave && (
      ...
      <View>
        ...
        <Text style={styles.selectedDate}>
          Selected Date Return: {dateReturn.toDateString()}
        </Text>
      </View>
      {errors.date_return && (
